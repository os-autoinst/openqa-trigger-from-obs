...
test -f /opt/openqa-trigger-from-obs/Virtualization:WSL/.run_last/openqa.cmd.log
grep -q 'scheduled_product_id => 1' /opt/openqa-trigger-from-obs/Virtualization:WSL/.run_last/openqa.cmd.log
